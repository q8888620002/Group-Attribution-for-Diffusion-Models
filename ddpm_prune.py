...
from diffusion.unetmodel import Upsample, Downsample, AttentionBlock, ResBlock
from diffusion.model_util import create_ddpm_model
...
parser.add_argument("--pruner", type=str, default='magnitude', choices=['taylor', 'random', 'magnitude', 'reinit', 'diff-pruning'])
